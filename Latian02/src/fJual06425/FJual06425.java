...
public class FJual06425 extends JFrame implements ActionListener, FocusListener {
    ...
    private JLabel lNoJual = new JLabel("No. Transaksi "),
            ...
            lToko1 = new JLabel("A12.2020.06425"),
            lToko2 = new JLabel("Dianna Yanuaresta");
    ...
    public FJual06425() {
        ...
        // mengatur disable edit/input
        fNoJual.setEditable(false);
    ...
    public static void main(String[] args) {
        new FJual06425().setVisible(true);
    }
    ...
    void CariNoJual() {
        try {
            ...
            String sql1 = "SELECT * FROM jual06425 ORDER BY notransaksi DESC LIMIT 1";
    ...
    void Cari() {
        try {
            ...
            String sql1 = "SELECT * FROM barang06425 WHERE kode ='" + fKode.getText() + "'";
            ResultSet rs1 = stat.executeQuery(sql1);
            if (rs1.next()) {
                // Jika Kode Barang Ditemukan Di Tabel Barang
    ...
    void SimpanJual() {
        try {
            ...
            for (int i = 0; i < brs; i++) {
                ...
                String strsql = "insert into jual06425(notransaksi, kode, harga, jumlah) " +
                        " values ('" + vnojual + "', '" + vkode + "', '" + vharga + "', '" + vjumlah + "')";

                int stsproses = stat.executeUpdate(strsql);

                // update data barang................................
                String strsqlupdate = "update barang06425 set jumlah = jumlah - '" + vjumlah + "' " +
                        " where kode = '" + vkode + "'";
