...
public class FBarang06425 extends JFrame implements ActionListener, MouseListener {
    ...
    Integer[] lebarklm = { 75, 200, 100, 100, 100, 100 };
    ...
    public FBarang06425() {
        ...
        btnAdd.setBounds(145, 385, 85, 25);
        btnAdd.setText("Add");
        btnKosong.setBounds(245, 385, 100, 25);
        btnKosong.setText("Bersihkan");
        btnAdd.setBackground(Color.green);
        btnAdd.setForeground(Color.getHSBColor(250, 0, 255));
        btnCari.setBounds(360, 385, 85, 25);
        btnCari.setText("Cari");
        btnKoreksi.setBounds(460, 385, 85, 25);
        btnKoreksi.setText("Koreksi");
        btnHapus.setBounds(560, 385, 85, 25);
        btnHapus.setText("Hapus");
        btnSelesai.setBounds(675, 385, 85, 25);
    ...
    public static void main(String[] args) {
        new FBarang06425().setVisible(true);
    }
    ...
    private void tampil() {
        try {
            ...
            fKode.setText(vkode);
            fNama.setText(vnama);
            fNama.setText(vhrgbeli);
            fNama.setText(vhrgjual);
            fNama.setText(vjumlah);
        } catch (Exception e) {
    ...
    void Add() {
        try {
            ...
            String strsqlcr = "SELECT * FROM barang06425 WHERE kode ='" + fKode.getText() + "'";
            ...
            String strsql = "insert into barang06425(kode, nama, hrgbeli, hrgjual,jumlah) values " +
    ...
    int Cari() {
        ...
        try {
            ...
            String strsql = "SELECT * FROM barang06425 WHERE kode ='" + fKode.getText() + "'";
            ResultSet rs = stat.executeQuery(strsql);

            if (rs.next()) {
                // Jika kode Ditemukan Di Tabel barang06425
    ...
    void Koreksi() {
        try {
            ...
            String strsql = "update barang06425 set nama='" + fNama.getText() +
                    "',hrgbeli='" + fHrgBeli.getText() + "',hrgjual='" + fHrgJual.getText() + "',jumlah='"
                    + fJumlah.getText() +
    ...
    void Hapus() {
        try {
            ...
            String strsql = "delete from barang06425 where kode='" + fKode.getText() + "' ";
            int stsproses = stat.executeUpdate(strsql);
    ...
    void tampiltabel() {
        try {
            ...
            String strsql = "select * from barang06425";
    ...
    void settombol(int a, int b, int c, int d, int e) {
        ...
        btnKosong.setEnabled(e >= 1 ? true : false);
    }
}
