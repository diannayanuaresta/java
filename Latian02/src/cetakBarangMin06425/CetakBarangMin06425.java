...
public class CetakBarangMin06425 extends JFrame implements ActionListener
{
	...
	public static void main(String[] args) {
		new CetakBarangMin06425().setVisible(true);
	}
    ...
    try {
      ...
      pjob.setPrintable(new Printable() 
      {
        public int print(Graphics g1, PageFormat pf, int pageNum) {
          ...
          g1.drawString("create by Dianna 06425", 10, 10);
          //cetak data....................................
		try
		{
			...
			//Koneksi ke table barang..................
	   		...
	   		String strsql = "SELECT * FROM barang06425 where jumlah <= '" + isikanjml + "'";
