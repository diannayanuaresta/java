...
public class CetakBarang06425 extends JPanel {
      ...
      pjob.setPrintable(new Printable() 
      {
		...
		try
		{
			//Koneksi ke table barang..................
	   		...
	   		g1.drawString("Harga", 350, 155);
	   		g1.drawString("Jumlah", 450, 155);
	   		...
	   		while(rs.next())
	   		{
	   			...
	   			g1.drawString(rs.getString(3),350,y1);
